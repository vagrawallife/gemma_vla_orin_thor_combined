# llama.cpp server for NVIDIA Jetson Thor
# CUDA architecture: sm_110 (Blackwell / Thor), JetPack 7 / r38.4, CUDA 13
# Multi-stage: no PyTorch, no Python ML stack -> minimal runtime image.
...
# sm_110 requires CUDA 13 toolkit present in the r38.x JetPack base image.
RUN cmake -B build \
        -DGGML_CUDA=ON \
